...
@Entity
@Table
public abstract class Awards extends Degree{
    
    @Column
    private String award_cur_type;

    @Column
    private double award_value;

    public Awards(long id, long createdByUser, long approvedByUser, long searchCount, Set<PandityaTags> allTags,
        ...
        this.award_cur_type = award_cur_type;
